...
public class AdminController implements Initializable {
    ...
    @FXML
    private StackPane glassLayer;
    @FXML
    private GaussianBlur glassBlur;

    @FXML
    private BorderPane mainBorderPane;

    @FXML
    private Button btnExplorer, btnVoyages, btnFavoris, btnMessages, btnRestaurant, btnParametres, btnLogout;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Button[] buttons = {btnExplorer, btnVoyages, btnFavoris, btnMessages, btnRestaurant, btnParametres, btnLogout};
        ...
        if (glassLayer != null) {
            ...
            glassLayer.setOnMouseEntered(e -> glassBlur.setRadius(18));
            glassLayer.setOnMouseExited(e -> glassBlur.setRadius(14));
        }
