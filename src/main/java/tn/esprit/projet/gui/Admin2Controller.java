...
public class Admin2Controller implements Initializable {
    ...
    private void connectToChatServer() {
        try {
            if (webSocketClient != null && webSocketClient.isOpen()) return; // Connection d-déjà ma7loula

            webSocketClient = new org.java_websocket.client.WebSocketClient(new java.net.URI("ws://localhost:8887")) {
                @Override public void onOpen(org.java_websocket.handshake.ServerHandshake h) { System.out.println("✅ Admin Connected"); }

                @Override
                public void onMessage(String m) {
                    Platform.runLater(() -> {
                        if (m.equals(lastProcessedMessage)) return; // 🚀 Anti-Duplicate
                        ...
                        // ❌ NA7I saveMessageToFile(msgClientId, m); <--- HEDHI HIYA EL 3ELLA
                ...
                @Override public void onClose(int i, String s, boolean b) { System.out.println("🛑 Admin Offline"); }
    ...
    private void loadSpecificChat(String clientId, String clientName) {
        ...
        if (adminChatMessageContainer != null) {
            // 🚀 FIX: Nadhaf el UI qbal ma tloady mel fichier
    ...
    private void handleAdminReply() {
        ...
        if (webSocketClient != null && webSocketClient.isOpen()) {
            ...
            // ✅ UI bech tet-updata wa7edha dakhil onMessage()
        }
    }
    ...
    private void handleClearHistory() {
        // 🚀 Hedha houwa el fix: fassa5 el source mta3 el chat
