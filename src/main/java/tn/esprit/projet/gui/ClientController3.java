...
public class ClientController3 implements Initializable {
    ...
    public void showHotelOnMap(tn.esprit.projet.entities.Hotel hotel) {
        javafx.concurrent.Task<Void> task = new javafx.concurrent.Task<>() {
            @Override protected Void call() throws Exception {
                ...
                Platform.runLater(() -> apiVC.showOpenStreetMapPreviewDialog(loc, url));
                return null;
            }
    ...
    public TextField        getClientSearchField()     { return searchField;          }
    public ComboBox<String> getRoomStatusFilterCombo() { return roomStatusFilterCombo; }
    public ComboBox<String> getRoomTypeFilterCombo()   { return roomTypeFilterCombo;  }
