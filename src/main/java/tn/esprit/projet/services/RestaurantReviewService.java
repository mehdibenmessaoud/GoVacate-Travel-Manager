...
public class RestaurantReviewService implements CRUD<RestaurantReview, Integer> {
    ...
    // Fixed: Return type changed to RestaurantReview
    @Override
    public RestaurantReview insert(RestaurantReview review) throws SQLException {
    ...
    // Fixed: Return type changed to RestaurantReview
    @Override
    public RestaurantReview update(RestaurantReview review) throws SQLException {
    ...
    // Fixed: Removed unused parameter to match standard interface
    @Override
    public List<RestaurantReview> selectAll() throws SQLException {
        List<RestaurantReview> reviews = new ArrayList<>();
        String sql = "SELECT * FROM restaurant_review";
        try (Statement st = cnx.createStatement();
             ResultSet rs = st.executeQuery(sql)) {
            while (rs.next()) {
                reviews.add(mapResultSetToEntity(rs));
            }
        }
        return reviews;
    }
    ...
    @Override
    public RestaurantReview getById(Integer id) throws SQLException {
    ...
    private RestaurantReview mapResultSetToEntity(ResultSet rs) throws SQLException {
