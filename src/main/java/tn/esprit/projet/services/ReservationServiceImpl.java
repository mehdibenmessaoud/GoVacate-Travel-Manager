...
public class ReservationServiceImpl implements IService<Reservation> {
    ...
    private Reservation mapResultSetToReservation(ResultSet rs) throws SQLException {
        ...
        r.setStatut(statut != null ? StatutReservation.valueOf(statut.toUpperCase()) : StatutReservation.EN_ATTENTE);

        java.sql.Date dateDebut = rs.getDate("date_debut");
        r.setDate_debut(dateDebut != null ? dateDebut.toLocalDate() : java.time.LocalDate.now());

        java.sql.Date dateFin = rs.getDate("date_fin");
        r.setDate_fin(dateFin != null ? dateFin.toLocalDate() : java.time.LocalDate.now());
