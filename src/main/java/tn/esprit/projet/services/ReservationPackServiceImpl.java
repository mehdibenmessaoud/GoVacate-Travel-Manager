...
public class ReservationPackServiceImpl implements CRUD<ReservationPack, Long> {
            ...
            try (PreparedStatement ps1 = cnx.prepareStatement(sqlRes, Statement.RETURN_GENERATED_KEYS)) {
                ...
                try (ResultSet rs = ps1.getGeneratedKeys()) {
                    if (rs.next()) {
                        ...
                        try (PreparedStatement ps2 = cnx.prepareStatement(sqlPack)) {
    ...
    @Override
    public ReservationPack insert(ReservationPack rp) { // Renamed from create
    ...
    @Override
    public List<ReservationPack> selectAll() { // Renamed from findAll
    ...
    @Override
    public ReservationPack getById(Long id) { // Renamed from findById
